...
public class manager {
    ...
    public void cadastra_cliente() {
        ...
        System.out.print("Informe o endere�o para entrega: ");
        endereco = sc1.next();

        System.out.print("Informe uma senha: ");
        password = sc1.next();

        c1 = new cliente(nome, cpf, endereco, password);
    ...
    public void cadastra_produto(cliente call) {
        ...
        if (call.getAdmin()) {
            ...
            System.out.printf("Informe o pre�o: ");
            preco = sc1.nextFloat();

            p1 = new produto(nome, cod, preco);
