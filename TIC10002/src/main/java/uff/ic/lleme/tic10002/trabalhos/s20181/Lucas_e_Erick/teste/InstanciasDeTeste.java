...
import uff.ic.lleme.tic10002.trabalhos.s20181.Lucas_e_Erick.Lista;
import uff.ic.lleme.tic10002.trabalhos.s20181.Lucas_e_Erick.model.Assunto;
import uff.ic.lleme.tic10002.trabalhos.s20181.Lucas_e_Erick.model.Cliente;
import uff.ic.lleme.tic10002.trabalhos.s20181.Lucas_e_Erick.model.TipoAssunto;
import uff.ic.lleme.tic10002.trabalhos.s20181.Lucas_e_Erick.model.Urgencia;
import java.time.LocalDateTime;
import java.time.Month;
import java.util.ArrayList;
import java.util.List;

public class InstanciasDeTeste {

    private List<Cliente> clientes;
    private List<TipoAssunto> tipoassuntos;

    public InstanciasDeTeste() {
        ...
        /*
		 * Assunto conteudo11 = new Assunto(ta1, null, null, 0); Assunto conteudo12 =
		 * new Assunto(ta1, null, null, 0); Assunto conteudo13 = new Assunto(ta5, null,
		 * null, 0); Assunto conteudo14 = new Assunto(ta3, null, null, 0); Assunto
		 * conteudo15 = new Assunto(ta2, null, null, 0); Assunto conteudo16 = new
		 * Assunto(ta4, null, null, 0);
         */
        int chaveAssunto = 0;

        Lista<Assunto> assunto1 = new Lista<Assunto>();
        assunto1.add(conteudo1, ++chaveAssunto);
        assunto1.add(conteudo3, ++chaveAssunto);
        Lista<Assunto> assunto2 = new Lista<Assunto>();
        assunto2.add(conteudo1, ++chaveAssunto);
        ...
        assunto7.add(conteudo1, ++chaveAssunto);
        ...
        Cliente c3 = new Cliente(452, 89, "maom�", assunto4, LocalDateTime.of(2018, Month.JUNE, 18, 11, 10));
        Cliente c4 = new Cliente(239, 67, "jo�o", assunto3, LocalDateTime.of(2018, Month.JUNE, 18, 11, 15));
