// ConsoleApplication1.cpp : Define o ponto de entrada para a aplica��o de console.
//
...
int main(int argc, char **argv) {
    ...
    // Total de vendas das filiais com c�digo entre 10 e 20
    std::cout << "O total de venda das filiais foi: "
            << query.getTotalSalesByBranch(10, 20) << std::endl;

    // Total de vendas das filiais com c�digo entre 10 e 20 no m�s 17/jan at� 17/jun
    std::cout << "O total de venda das filiais foi: "
