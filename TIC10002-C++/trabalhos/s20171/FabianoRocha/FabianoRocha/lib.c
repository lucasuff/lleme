...
//#################################################
//#### Fun��es referente a AVL1 - chave Filial ####
//#### Fun��o respons�vel por inserir N� na AVL ####
...
void insere(int filial, int ano, int mes, float totalVendido) {
    ...
    }        //Caso j� exista n� raiz, efetua a insers�o do n� a esquerda ou a direita da AVL
    else {
        aux1 = raiz;
        aux2 = aux1;
    ...
    //Ap�s inserido novo N�, verifica se AVL est� desbalanceada e efetua balanceamento se necess�rio
    if (aux2) {
        while (aux2) {
...
//#### Fun��o respons�vel por buscar pela chave desejada na AVL
...
//#### Fun��o respons�vel por calcular a altura da AVL ####
...
//#### Fun��o respons�vel por efetuar a rota��o a direita ####
...
//#### Fun��o respons�vel por efetuar a rota��o a esquerda ####
...
//#### Fun��o respons�vel por efetuar o balanceamento da AVL ####
...
//#################################################
//#### Fun��es referente a AVL2 - chave Ano ####
//#### Fun��o respons�vel por inserir N� na AVL ####
...
//#### Fun��o respons�vel por liberar a mem�ria utilizada pelas AVL ####
...
//#################################################
//#### Fun��es referente as Consultas ####
//#### Fun��o respons�vel por realizar a consulta tipo 1
