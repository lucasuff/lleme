...
void InsereAVL(arvoreAVL *adesc, int dadonovo, int d, int e, int f) {
    ...
    // Parte do c�digo que faz a rota��o simples-------------------------------------
    ...
    // Parte do c�gido que faz a rota��o dupla --------------------------------------
    ...
    // Essa parte do c�digo faz o ajuste de fatores de balanceamento ---------------
    ...
    // Parte que � realizado o balanceamento da �rvore AVL -------------------------
    ...
    // Inicia a parte do c�digo que Insere na �rvore AVL ----------------------------
    paux = adesc->dir;
