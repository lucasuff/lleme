...
/*
 * Declarando a data de in�cio das atividades da empresa
 */
int const inauguracao = 2015;

/*
 * Lista com o n�mero de funcion�rios de cada filial
 */
...
avl_node *avlTree::insert(avl_node *root, int filial, int funcionario, int ano, int mes, float valor) {
    int posicao = ((ano - inauguracao)*12)+(mes - 1); //calculando a posi��o na lista do funcion�rio
    if (root == NULL) {
        root = new avl_node;
...
/*
 * Declara��o do n� da �rvore de meses
 */
