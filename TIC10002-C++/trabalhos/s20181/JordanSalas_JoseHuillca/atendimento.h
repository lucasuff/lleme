...
public:
    ...
    inline Cliente getCliente() {
        return cliente;
    }

    inline MyList<Assunto> getAssuntos() {
        return assuntos;
    }

    inline double getHoraChegada() {
        return horaChegada;
    }

    inline double getHoraAtendimento() {
        return horaAtendimento;
    }

    inline float getPrioridade() {
        return prioridade;
    }

    inline void setHoraChegada(double horaChegada_) {
        horaChegada = horaChegada_;
    }

    inline void setHoraAtendimento(double horaAtendimento_) {
        horaAtendimento = horaAtendimento_;
    }
